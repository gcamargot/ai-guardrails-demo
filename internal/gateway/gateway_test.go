...
func (invalidCoffeeStation) Status(context.Context, string) (gateway.CoffeeStationStatus, error) {
...
func (station unreachableCoffeeStation) Status(context.Context, string) (gateway.CoffeeStationStatus, error) {
